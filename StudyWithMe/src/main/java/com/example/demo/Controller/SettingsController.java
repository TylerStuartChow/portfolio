...
public class SettingsController extends SaveState implements Initializable {
    ...
    private void setLightMode(){
        parent.getStylesheets().remove(Launcher.class.getResource("darkMode.css").toExternalForm());
        parent.getStylesheets().add(Launcher.class.getResource("lightMode.css").toExternalForm());
